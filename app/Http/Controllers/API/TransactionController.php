...
class TransactionController extends Controller
{
    ...
    public function checkout(Request $request)
    {
        ...
        return responseformatter::success(
            $transaction->load(['transactionitem.product.productgallery']), // mengambil data pada variabel transaction serta melakukan load pada method product pada model yang ada pada transaction item pada model transaction (relationship)
            'Transaksi Berhasil'
        );
    }
}